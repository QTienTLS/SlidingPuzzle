...
export default {
    ...
    methods: {
        switchCell(rowIndex, cellIndex) {
            ...
            if (this.matrix[rowIndex][cellIndex] === 0)
                return;
            ...
            else if (rowIndex < this.matrix.length - 1 && this.matrix[rowIndex + 1][cellIndex] === 0) {
                this.matrix[rowIndex + 1][cellIndex] = this.matrix[rowIndex][cellIndex];
                this.matrix[rowIndex][cellIndex] = 0;
            }
            ...
            else if (cellIndex < this.matrix[rowIndex].length - 1 && this.matrix[rowIndex][cellIndex + 1] === 0) {
                this.matrix[rowIndex][cellIndex + 1] = this.matrix[rowIndex][cellIndex];
                this.matrix[rowIndex][cellIndex] = 0;
            }
        },
